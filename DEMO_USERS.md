...
curl -X POST "https://multi-tenant-build.preview.emergentagent.com/api/auth/login" \
...
curl "https://multi-tenant-build.preview.emergentagent.com/api/jobs"

# Check user profile progress
curl -X GET "https://multi-tenant-build.preview.emergentagent.com/api/auth/me" \
...
**Start testing by visiting:** https://multi-tenant-build.preview.emergentagent.com