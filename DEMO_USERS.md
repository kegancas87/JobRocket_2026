...
curl -X POST "https://job-expiry-fix.preview.emergentagent.com/api/auth/login" \
...
curl "https://job-expiry-fix.preview.emergentagent.com/api/jobs"

# Check user profile progress
curl -X GET "https://job-expiry-fix.preview.emergentagent.com/api/auth/me" \
...
**Start testing by visiting:** https://job-expiry-fix.preview.emergentagent.com