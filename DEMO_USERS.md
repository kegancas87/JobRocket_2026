...
curl -X POST "https://recruiter-dash-build.preview.emergentagent.com/api/auth/login" \
...
curl "https://recruiter-dash-build.preview.emergentagent.com/api/jobs"

# Check user profile progress
curl -X GET "https://recruiter-dash-build.preview.emergentagent.com/api/auth/me" \
...
**Start testing by visiting:** https://recruiter-dash-build.preview.emergentagent.com